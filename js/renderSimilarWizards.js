...
(function () {
  ...
  (function () {
    for (var i = 0; i < WIZARDS_AMOUNT; i++) {
      var fullNameWizard = WIZARDS_NAMES[window.util.getRandomNumber(WIZARDS_NAMES_AMOUNT_MIN, WIZARDS_NAMES_AMOUNT_MAX)] + ' ' + WIZARDS_SURNAMES[window.util.getRandomNumber(WIZARDS_NAMES_AMOUNT_MIN, WIZARDS_NAMES_AMOUNT_MIN)];
